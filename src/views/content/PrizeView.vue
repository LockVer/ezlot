<template>
    <div class="home">
        ...
        <b-table :data="DataListFiltered"
            ...
            <b-table-column field="agentName" label="NAME" width="200" sortable v-slot="props">
                {{ props.row.agentName }}
            </b-table-column>

            <b-table-column field="amount" label="STATUS" width="200" sortable v-slot="props">
                {{ props.row.amount }}
            </b-table-column>

            <b-table-column field="status" label="REDEEMED" width="100" sortable v-slot="props">
                {{ ["INACTIVE","ACTIVATED","RECEIVED","REDEEMED"][props.row.status] }}
            </b-table-column>

            <b-table-column field="pdName" label="PRODUCT NAME" width="100" sortable v-slot="props">
                {{ props.row.pdName }}
            </b-table-column>
...
export default {
    ...
    computed: {
        DataListFiltered() {
            // 定义你想要检查的字段
            const fieldsToFilterBy = ["agentName", "amount", "pdName"];
